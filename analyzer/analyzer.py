...
@click.option('-s', '--short', 'is_short', type=bool, default=False, show_default=True, is_flag=True, help='Hide the main visitor output.')
@click.argument('file-path', type=str)
def _main(is_readable, is_compact, is_short, file_path):
